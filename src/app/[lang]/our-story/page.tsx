...
export default async function OurStoryPage({ params: { lang } }: OurStoryPageProps) {
  ...
  return (
    <div className="container mx-auto px-4 py-8 space-y-16">
      <header className="mb-12 text-center">
        ...
        <p className="text-muted-foreground mt-2 max-w-2xl mx-auto">Conoce la trayectoria de MADE, desde nuestros humildes comienzos hasta convertirnos en un referente en el sector maderero de República Dominicana.</p>
      </header>
